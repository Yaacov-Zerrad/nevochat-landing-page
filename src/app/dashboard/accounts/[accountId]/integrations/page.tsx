      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Connectez des services externes à votre compte</p>
          </div>
          ...
          >
            <h2 className="text-xl font-semibold text-foreground mb-4">Clés API</h2>
            <p className="text-muted-foreground mb-4">Gérez vos clés API pour les intégrations personnalisées</p>
            
            <div className="space-y-3">
              <div className="flex items-center justify-between bg-secondary/50 p-4 rounded-lg">
                <div>
                  <h4 className="text-foreground font-medium">API Key principale</h4>
            ...
            <button className="mt-4 bg-primary/20 text-primary px-4 py-2 rounded-lg hover:bg-primary/30 transition-colors">
              + Nouvelle clé API
            </button>
          </motion.div>
        </motion.div>
