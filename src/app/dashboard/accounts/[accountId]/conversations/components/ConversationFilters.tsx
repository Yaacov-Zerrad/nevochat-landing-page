      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <motion.div
            ...
            className="bg-gray-900 border border-neon-green/30 rounded-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col"
          >
            {/* Modal Header */}
            <div className="sticky top-0 bg-gray-900 z-10 p-6 border-b border-white/10 flex justify-between items-center">
              <div>
            ...
            <div className="overflow-y-auto flex-1 p-6">
              ...
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
                  <svg className="w-5 h-5 mr-2 text-neon-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <label className="flex items-center space-x-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 rounded border-white/10 bg-white/5 text-neon-green focus:ring-neon-green/50 focus:ring-offset-0"
              />
              <span className="text-white">Non assignées</span>
            </label>
            ...
            <label className="flex items-center space-x-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 rounded border-white/10 bg-white/5 text-neon-green focus:ring-neon-green/50 focus:ring-offset-0"
              />
              <span className="text-white">Messages non lus</span>
            </label>
            ...
            <label className="flex items-center space-x-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 rounded border-white/10 bg-white/5 text-neon-green focus:ring-neon-green/50 focus:ring-offset-0"
              />
              <span className="text-white">En pause</span>
            </label>
          </div>
        </div>
      ...
      <div className="sticky bottom-0 bg-gray-900 border-t border-white/10 p-6">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onClose}
              className="px-5 py-2 bg-white/5 border border-white/10 rounded-lg text-white hover:bg-white/10 transition-colors"
            >
              Annuler
            </button>
            <button
              onClick={handleApply}
              className="px-6 py-2 bg-neon-green/20 border border-neon-green/30 rounded-lg text-neon-green hover:bg-neon-green/30 transition-colors font-medium flex items-center gap-2"
            >
