    ...
    <AnimatePresence mode="wait">
      {!selectedConversation ? (
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          exit={{ opacity: 0, x: 20 }}
          className="flex flex-col h-[600px] -mx-6"
        >
          {/* Header */}
          <div className="px-6 py-4 border-b border-white/10 bg-white/5">
            <div className="flex items-center space-x-3">
              ...
              <span className={`text-xs px-2 py-1 rounded-full ${statusLabels[selectedConversation.status as keyof typeof statusLabels].color}`}>
          ...
          <div className="px-6 py-4 border-t border-white/10 bg-white/5">
            <div className="flex items-end space-x-2">
              <textarea
                ...
                rows={1}
                className="flex-1 bg-gray-700/80 text-white px-4 py-3 rounded-2xl border border-gray-600/50 focus:border-neon-green/50 focus:outline-none text-sm resize-none"
                style={{
                  minHeight: '44px',
                  maxHeight: '120px'
                }}
