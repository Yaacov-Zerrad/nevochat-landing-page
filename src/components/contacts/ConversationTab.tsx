  ...
  return (
    <AnimatePresence mode="wait">
      {!selectedConversation ? (
        ...
        >
          ...
          <div className="divide-y divide-gray-700/30 -mx-6">
            ...
            <div className="flex items-start space-x-3">
              {/* Avatar */}
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-neon-green/20 to-emerald-500/20 rounded-full flex items-center justify-center flex-shrink-0 border border-neon-green/20">
                <span className="text-neon-green font-semibold text-base sm:text-lg">
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* Meta info */}
                <div className="flex items-center justify-between text-xs sm:text-sm text-gray-400 mb-1.5 sm:mb-2 gap-2">
                  <div className="flex items-center space-x-1.5 sm:space-x-2 min-w-0 flex-1">
                  ...
                  <div className="flex items-center space-x-1.5 sm:space-x-2 flex-shrink-0">
                    {conversation.unread_count > 0 && (
                      <span className="bg-red-500 text-white text-xs px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full min-w-[20px] text-center">
        ...
        >
          {/* Header */}
          <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-white/10 bg-white/5 flex-shrink-0">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <button
                onClick={handleBackToList}
                className="text-neon-green hover:text-neon-green/80 transition-colors p-1 rounded-lg hover:bg-neon-green/10"
              >
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-gray-400">#{selectedConversation.display_id}</p>
                </div>
              </div>
                        ...
                        {message.attachments && message.attachments.length > 0 && (
                          <div className="space-y-2 mt-2">
                            {message.attachments.map((attachment) => {
                              ...
                              return (
                                <div key={attachment.id} className="bg-gray-700/50 rounded-lg p-2">
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-xs text-white truncate flex-1">{attachment.filename}</span>
          ...
          {/* Input */}
          <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-white/10 bg-white/5 flex-shrink-0">
            <div className="flex items-end gap-1.5 sm:gap-2">
              <textarea
                ...
                placeholder="Message..."
                rows={1}
                className="flex-1 bg-gray-700/80 text-white px-3 py-2.5 sm:px-4 sm:py-3 rounded-2xl border border-gray-600/50 focus:border-neon-green/50 focus:outline-none text-sm resize-none"
                style={{
                  minHeight: '40px',
                  maxHeight: '120px'
                }}
