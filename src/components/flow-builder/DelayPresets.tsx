    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        {presets.map((preset, index) => (
          <div 
            key={index}
            className="bg-gray-700 p-3 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors cursor-pointer"
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <svg className="w-4 h-4 text-gray-400 hover:text-neon-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
